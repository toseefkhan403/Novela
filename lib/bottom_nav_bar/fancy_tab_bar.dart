...
import 'package:arctic_pups/bottom_nav_bar/tab_item.dart';
                  ...
                  callbackFunction: () {
                    if(currentSelected != 0) {
                      setState(() {
                        nextIcon = Icons.home;
                        currentSelected = 0;
                        App.myTabbedPageKey.currentState.tabController.animateTo(0);
                      });
                  ...
                  callbackFunction: () {
                    if(currentSelected != 2) {
                      setState(() {
                        ...
                        currentSelected = 2;
                        App.myTabbedPageKey.currentState.tabController.animateTo(2);
                      });
                      _initAnimationAndStart(_positionAnimation.value, 1);
                    }
                  })

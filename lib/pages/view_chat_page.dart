...
class _ViewChatsState extends State<ViewChats> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: DefaultAppBar(widget.title, widget.totalEpisodes, episodeNo,
          widget.storyImage, widget.genre),
      body: Container(
  ...
  Widget _whatWidget(BuildContext context, data) {
    ...
    switch (data['type']) {
                ...
                children: <Widget>[
                  ...
                  Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(colors: textBoxColor()),
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          if (callCount == 0) {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => Call(data)));
            ++callCount;
          }
        });
      ...
      case 'image':
        return ImageStatefulWidget(isRight, data, widget.genre);
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      String link = "https://play.google.com/store/apps/details?id=com.pandog.arctic_pups";
                      Share.text(
                          'Novela',
                          'Hey! I am reading this amazing text story called \'${widget.title}\' and I think you\'d like it too! \nHere\'s the link to download the app: $link',
                          'text/plain');
                    },
                    child: Chip(
                        backgroundColor: kShrinePink500,
                          ...
                          child: Container(
                            child: Column(
                              ...
                              children: <Widget>[
                                Container(
                                  margin:
                                      EdgeInsets.only(top: 75.0, bottom: 12.0),
                                  width: 200,
                                  child: Text(
                                    widget.title,
                                    textAlign: TextAlign.center,
  ...
  Color backgroundColor() {
    if (widget.genre == "Horror" || widget.genre == "Thriller") {
      return Colors.black;
    } else {
      return Colors.white;
    }
  ...
  textBoxColor() {
    if (widget.genre == "Horror" || widget.genre == "Thriller") {
      ...
      return [Colors.blue, Colors.blue.withOpacity(0.6)];
    }
  }
}
